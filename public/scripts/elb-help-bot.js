/**
 * ELB Assistant â€” Precision Retrieval Engine v4.9.0
...
(function () {
  ...
  function compareSearchResults(a, b) {
    ...
    var aBand = (a.matchPercent || 0) >= 50 ? 1 : 0;
    var bBand = (b.matchPercent || 0) >= 50 ? 1 : 0;
